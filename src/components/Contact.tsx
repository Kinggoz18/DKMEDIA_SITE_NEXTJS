...
export default function Contact(props: ContactProps) {
  ...
  return (
    <>
      <footer className="bottom-0 releative row-start-3 flex flex-col items-start gap-[24px] flex-wrap justify-start px-[20px] py-10 lg:px-[40px] lg:py-[20px] lg:hidden">
